            ...
            if (field.isAnnotationPresent(StringLength.class)) {
                if (value instanceof String) {
                    ...
                    if (str.length() < stringLength.min() || str.length() > stringLength.max()) {
                        throw new Exception("Field " + field.getName() + " must have a length between " +
                                stringLength.min() + " and " + stringLength.max() + ".");
                    }
                } else {
                    throw new Exception("Field " + field.getName() + " must be a String for @StringLength annotation.");
                }
            }
            ...
            if (field.isAnnotationPresent(MinValue.class)) {
                if (value instanceof Integer) {
                    ...
                    if (intValue < minValue.value()) {
                        throw new Exception("Field " + field.getName() + " must be at least " + minValue.value() + ".");
                    }
                } else {
                    throw new Exception("Field " + field.getName() + " must be an Integer for @MinValue annotation.");
                }
            }
            ...
            if (field.isAnnotationPresent(MaxValue.class)) {
                if (value instanceof Integer) {
                    ...
                    if (intValue > maxValue.value()) {
                        throw new Exception("Field " + field.getName() + " must be at most " + maxValue.value() + ".");
                    }
                } else {
                    throw new Exception("Field " + field.getName() + " must be an Integer for @MaxValue annotation.");
                }
            }
        }
    }
